...
namespace CliverRoutinesTests
{
    ...
    public class DateTimeRoutinesTests
    {
        ...
        List<DTTest> get_tests2()
        {
            ...
            tests.Add(new DTTest(@"Member since:  05/07/2024 Tue 06:00 AM", new DateTime(2024, 5, 7, 6, 0, 0, DateTimeKind.Utc)));
        ...
        List<DTTest> get_tests1()
        {
            ...
            tests.Add(new DTTest(@"Member since:  05/07/2024 Tue 06:00 AM", new DateTime(2024, 5, 7, 6, 0, 0)));
